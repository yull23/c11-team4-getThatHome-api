...
ActiveRecord::Schema[7.0].define(version: 2023_10_15_030510) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "mi_usuarios", force: :cascade do |t|
    t.string "email"
    t.string "password_digest"
    t.string "token"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["token"], name: "index_mi_usuarios_on_token", unique: true
  end
